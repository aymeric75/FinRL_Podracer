...
class Evaluator:
    ...
    def evaluate_and_save(self, actor: th.nn, steps: int, exp_r: float, logging_tuple: tuple):
        ...
        if if_save:
            ...
            # [(2560, 191.20436096191406, 40.79072570800781, -113.7437515258789, np.float64(0.004072536685271189), np.float64(-0.14539765659719706), np.float64(113.50592803955078))]
            print("WAS1111")
            #exit()
